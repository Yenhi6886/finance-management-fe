          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start space-x-2 py-2">
              <input
                  type="checkbox"
                  id="terms"
                  className="w-4 h-4 mt-0.5 border-border rounded text-primary focus:ring-primary"
              />
            ...
            <Button
                type="submit"
                className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-lg mt-6 text-sm"
                disabled={loading}
            >
