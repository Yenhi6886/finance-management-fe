              ...
              {transactionResult.success ? (
                  <>
                    ...
                    <p className="text-muted-foreground mb-4">
                      Đã nạp {formatCurrency(transactionResult.amount, 'VND', settings)} vào ví {transactionResult.walletName}
                    </p>
                  </>
              ) : (
                  <>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      {wallets.map(w => (
                          <option key={w.id} value={w.id}>{w.name} - {formatCurrency(w.balance, w.currency, settings)}</option>
                      ))}
                    </select>
