...
import { Textarea } from '@/components/ui/textarea'; // Assuming Textarea is available or will be created
import { CalendarIcon } from 'lucide-react';
import { Popover, PopoverContent, PopoverTrigger } from '@/components/ui/popover'; // Assuming Popover is available
import { Calendar } from '@/components/ui/calendar'; // Assuming Calendar is available
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Nhập thông tin chi tiết cho khoản chi của bạn.
          </DialogDescription>
        </DialogHeader>
